...
public class DragonBones_UnityArmatureComponentWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("textureAtlasName", get_textureAtlasName, set_textureAtlasName);
	...
	static int get_textureAtlasJSON(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index textureAtlasJSON on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_textureAtlasName(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			DragonBones.UnityArmatureComponent obj = (DragonBones.UnityArmatureComponent)o;
			string ret = obj.textureAtlasName;
			LuaDLL.lua_pushstring(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index textureAtlasName on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_textureAtlasName(IntPtr L)
	{
		object o = null;
