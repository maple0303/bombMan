...
namespace DragonBones
{
    ...
    public class UnityArmatureEditor : Editor
    {
        ...
        public static void _changeArmatureData(UnityArmatureComponent _armatureComponent, string armatureName, string dragonBonesName, string textureAtlasName)
        {
            Slot slot = null;
            if (_armatureComponent.armature != null)
            {
            ...
            _armatureComponent = UnityFactory.factory.BuildArmatureComponent(_armatureComponent.armatureName, dragonBonesName, null, textureAtlasName, _armatureComponent.gameObject);
        ...
        private TextAsset _dragonAtlasJSON = null;  //图集数据
        ...
        void OnEnable()
        {
            ...
            )
            {
                ...
                // Refresh armature.
                _changeArmatureData(_armatureComponent, _armatureComponent.armatureName, dragonBonesData.name, _armatureComponent.textureAtlasName);
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            _dragonAtlasJSON = EditorGUILayout.ObjectField("Atlas Data", _dragonAtlasJSON, typeof(TextAsset), false) as TextAsset;
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.Space();
            ...
            if (created)
            {
                ...
                if (_changeDragonBonesData(_armatureComponent, _dragonBoneJSON, _dragonAtlasJSON))
                {
                    _updateParameters();
                }
                else
