...
namespace DragonBones
{
    ...
    public abstract class BaseFactory
    {
         ...
         * @version DragonBones 4.5
         */
        public void ReplaceSlotDisplay(string dragonBonesName, string armatureName, string slotName, string displayName, Slot slot, int displayIndex = -1, string textureAtlasName = null)
        {
            var dataPackage = new BuildArmaturePackage();
            if (_fillBuildArmaturePackage(dataPackage, dragonBonesName, armatureName, null, textureAtlasName))
            {
